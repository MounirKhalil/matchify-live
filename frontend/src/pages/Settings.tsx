...
const Settings = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      // Delete user's CV from storage if exists
      ...
      // Delete from candidate_profiles or recruiter_profiles
      ...
      // Delete the auth user and all data using the database function
